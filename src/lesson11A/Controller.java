...
//обрабатывает запросы на ресурсе
public class Controller {
    ...
    public Room[] requestRooms(int price, int persons,String city,String hotel){
        ...
        //недоработано (NullException) - если какой - то из массивов равен 0
        ...
        for (int i = 0; (i+count1+1) < count2; i++) {
            rooms1[count1+1+i] = rooms12[i];
        }
        for (int i = 0; (i+count2+1) < count; i++) {
            rooms1[(count2+1)+i] = rooms11[i];
        }
        return rooms1;
    }
