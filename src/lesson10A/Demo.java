...
public class Demo {
    public static void main(String[] args) {
        Customer customerOwned=new Customer("Николай","Москва","Мужской");
        Customer customerOwned2=new Customer("Федор","Киев","Женский");

        ElectronicsOrder electronicsOrder=new ElectronicsOrder("Заказчик", new Date(), "Одесса", "Киев",700, customerOwned, 12,369);
        ElectronicsOrder electronicsOrder2=new ElectronicsOrder("Заказчик", new Date(), "Москва", "Калининград", 500, customerOwned2, 12,700);
